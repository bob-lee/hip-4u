  ...
  return (
    <div className="about">
      <div className="content">
        ...
        <p>
          I generally have three or four half day clinics per week, and two or three operating sessions, with all the surgery being undertaken in the Wairarapa Hospital operating theatres, which are leased by Selina Sutherland Hospital.
        </p>
        <p>
          It is generally accepted that your GP is actually in charge of your overall healthcare, and a referral from your GP is required, before I can see you. Selina Sutherland is an affiliated Southern Cross provider. For insurance and ACC cases, a referral from your GP is also needed before any funding will be released, either for your consultation, or your surgery.
        </p>
        <p>
