...
const Dropdown = (props) => {
  ...
  const classes = props.title === 'more' ? 'ddm' : 'ddm active'
  return (
    <div className={classes} to="/">
      ...
      <div className="dd" onClick={handleOverlay}>
        <NavLink activeClassName="active" to="/personal">personal</NavLink>
        <NavLink activeClassName="active" to="/history">history</NavLink>
        <NavLink activeClassName="active" to="/certificates">certificates</NavLink>
